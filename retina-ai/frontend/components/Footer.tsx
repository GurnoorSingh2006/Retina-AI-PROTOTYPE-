    ...
    <footer className="bg-[#050505] border-t border-white/10 text-neutral-400 text-xs py-12 mt-auto font-mono">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-neutral-400">
              ...
              <li><Link href="/pathologies" className="hover:text-white transition">Diseases Guide</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="bg-black/40 p-3.5 rounded-xl border border-white/10 text-[11px] text-neutral-400 leading-normal flex items-start space-x-2.5">
              ...
              <span>
                OCTalyze is an AI-assisted screening research tool. Predictions and attention heatmaps do not constitute medical diagnoses. All clinical decisions must be validated by certified ophthalmologists.
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-neutral-400 text-[11px] tracking-wider">
          <p>OCTALYZE (c) 2026 // WE SEE WHAT YOU DON&apos;T.</p>
          <div className="flex items-center space-x-6">
            <Link href="/pathologies" className="hover:text-white transition">DISEASES GUIDE</Link>
